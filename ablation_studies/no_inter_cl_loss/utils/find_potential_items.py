...
def find_potential_negatives(df, similarity_matrix, threshold=0.5):
    # 初始化潜在正样本的字典
...
if __name__ == '__main__':
    ...
    potential_positives = find_potential_negatives(df,item_sim_matrix,0.5)
    print('start save')
    with open(f'../../datasets/{dataset}/{domain}/user_pos_items_doc_emb_256_0.5.pkl','wb') as f:
