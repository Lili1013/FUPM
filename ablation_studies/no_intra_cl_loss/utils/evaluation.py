...
def pred_one_user(u_id, items):
    ...
    # u_feats, pred_prob, u_id_feats, v_id_feats, u_review_feats, v_review_feats, potential_item_id_feats
    _,pred_prob, u_id_feats,v_id_feats,_,_,_= _model.forward(user_id_input, item_id_input,_overlap_user_protos,_user_inter_nums)
    return pred_prob
