...
from models.local_model_1 import Local_Model
...
def update_local_protos(local_data,model,device,flag,args,pca):
    # update prototypes
    ...
    user_centroid_dict = {}
    if flag == 'initial':
        user_review_emb = torch.tensor(pca.fit_transform(local_data.user_review_emb)).to(device)
...
def local_model_update(args, P, overlap_user_protos, model, local_data,optimizer,device,round_number,client_number,cat_labels,pca):
    ...
    #update prototypes
    user_centroid_dict = update_local_protos(local_data=local_data,model=model,device=device,flag='',args=args,pca=pca)
...
def get_rep_proto():
    ...
    logger.info(f'parameter settings: batch_size:{args.batch_size},lr:{args.lr},embed_id_dim:{args.embed_id_dim},'
                f'alpha:{args.alpha},gamma:{args.gamma}, beta:{args.beta}, noise:{args.lap_noise}, delta:{args.delta},'
    ...
    # best_model_list = [f'../best_models/douban/douban_book_music_book_emb_256_alpha_0.01_beta_0.4_lr_0.001_b_128_11_1.model',
    #                    f'../best_models/douban/douban_book_music_music_emb_256_alpha_0.01_beta_0.4_lr_0.001_b_128_11_1.model']
    best_model_list = [
        f'../best_models/amazon/amazon_phone_sport_phone_emb_256_alpha_0.01_beta_0.4_lr_0.001_b_128_10_30.model',
        f'../best_models/amazon/amazon_phone_sport_sport_emb_256_alpha_0.01_beta_0.4_lr_0.001_b_128_10_30.model']
    for j in range(args.client_num):
        ...
        model_params[args.client_names[j]].update({
            ...
            'dislike_path': local_data.dislike_item_dict,
    ...
    for i in range(args.client_num):
        user_centroid_dict = update_local_protos(local_data=local_data_list[i], model=local_model_list[i],
                                                 device=device,
                                                 flag='initial', args=args,pca=pca)
