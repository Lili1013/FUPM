...
def parse():
    ...
    parser.add_argument('--batch_size', type=int, default=3000, metavar='N', help='input batch size for training')
    parser.add_argument('--embed_id_dim', type=int, default=256, metavar='N', help='gnn embedding size')
    # parser.add_argument('--disen_embed_dim', type=int, default=256, metavar='N', help='disen feature embedding size')
    parser.add_argument('--review_embed_dim', type=int, default=256, metavar='N', help='review embedding size')
    ...
    #                     metavar='N', help='the clients')
    # parser.add_argument('--client_names', type=list,
    #                     default=['amazon_sport_cloth_phone_sport', 'amazon_sport_cloth_phone_cloth','amazon_sport_cloth_phone_phone'],
    #                     metavar='N', help='the clients')
    parser.add_argument('--tau', type=float, default=0.2,
                        metavar='N', help='the temperature of contrastive loss')
    parser.add_argument('--global_proto_agg_way', type=str, default='weight',
