...
from utils.evaluation_failure_status import calculate_hr_ndcg
    ...
    for j in range(args.client_num):
        ...
        if j == 0:
            pretrain_dict = torch.load(
                'best_models/douban/douban_book_music_book_emb_256_alpha_0.01_beta_0.4_lr_0.001_b_128_10_30.model',
                map_location=lambda storage, loc: storage)
        else:
            pretrain_dict = torch.load(
                'best_models/douban/douban_book_music_music_emb_256_alpha_0.01_beta_0.4_lr_0.001_b_128_10_30.model',
                map_location=lambda storage, loc: storage)
